...
public class PerformanceTests_10_09I01D90F
{
    private InstructionDescriptor[][] instructionSets;
    private SkipList<Integer> testSkipList;
    private MDList<Integer> testMDList;
    private static final int KEY_SPACE = (int)Math.round(Math.pow(2, 10));
    private static final double INSERT_PROPORTION = 0.09;
    private static final double DELETE_PROPORTION = 0.01;
    private static final double FIND_PROPORTION = 0.9;
